...
public class ServletCarrito extends HttpServlet {
	...
	private void insertarEnCarrito(HashMap<String, Integer> carrito, String producto) {
		if (carrito.get(producto)==null)
			...
			int nArticulos = (Integer)carrito.get(producto).intValue();
			carrito.put(producto, new Integer(nArticulos+1));
		}
	}
	
	private String carritoEnHTML(Map<String,Integer> carrito) {
		String c = "";
		for(String elem: carrito.keySet())
			c += "<p>["+ elem +"], "+ carrito.get(elem) +" unidades</p>";
		return c;
	}
